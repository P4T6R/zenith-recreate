...
const Contact = () => {
  return (
    <div>
        ...
        <div className="container-custom">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            >
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  <div className="bg-zenith-red/10 p-3 rounded-full mr-4">
                    <MapPin className="text-zenith-red" />
                  </div>
                  <div>
                    <h3 className="font-semibold text-zenith-black">Adresse</h3>
                ...
                <div className="flex items-start">
                  <div className="bg-zenith-red/10 p-3 rounded-full mr-4">
                    <Phone className="text-zenith-red" />
                  </div>
                  <div>
                    <h3 className="font-semibold text-zenith-black">Téléphone</h3>
                ...
                <div className="flex items-start">
                  <div className="bg-zenith-red/10 p-3 rounded-full mr-4">
                    <Mail className="text-zenith-red" />
                  </div>
                  <div>
                    <h3 className="font-semibold text-zenith-black">Email</h3>
                ...
                <div className="flex items-start">
                  <div className="bg-zenith-red/10 p-3 rounded-full mr-4">
                    <Globe className="text-zenith-red" />
                  </div>
                  <div>
                    <h3 className="font-semibold text-zenith-black">Site web</h3>
                ...
                <div className="flex items-start">
                  <div className="bg-zenith-red/10 p-3 rounded-full mr-4">
                    <Clock className="text-zenith-red" />
                  </div>
                  <div>
                    <h3 className="font-semibold text-zenith-black">Horaires d'ouverture</h3>
            ...
            <motion.div
              ...
              transition={{ duration: 0.5 }}
              viewport={{ once: true }}
              className="bg-zenith-gray/20 p-8 rounded-lg"
            >
      ...
      {/* Map Section */}
      <section className="h-[400px] w-full bg-zenith-gray">
